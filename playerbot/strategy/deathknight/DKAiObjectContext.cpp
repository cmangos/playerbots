    ...
    namespace DK
    {
        ...
        public:
            TriggerFactoryInternal()  
            {
				...
				creators["summon gargoyle"] = [](PlayerbotAI* ai) { return new SummonGargoyleTrigger(ai); };
				creators["dancing weapon"] = [](PlayerbotAI* ai) { return new DancingWeaponTrigger(ai); };
				creators["killing machine"] = [](PlayerbotAI* ai) { return new KillingMachineTrigger(ai); };
				creators["unholy frenzy"] = [](PlayerbotAI* ai) { return new UnholyFrenzyTrigger(ai); };
				creators["obliterate"] = [](PlayerbotAI* ai) { return new ObliterateTrigger(ai); };
				creators["scourge strike"] = [](PlayerbotAI* ai) { return new ScourgeStrikeTrigger(ai); };
				creators["frost strike"] = [](PlayerbotAI* ai) { return new FrostStrikeTrigger(ai); };
				creators["rime"] = [](PlayerbotAI* ai) { return new RimeTrigger(ai); };
