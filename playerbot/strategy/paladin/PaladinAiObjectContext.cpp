    ...
    namespace paladin
    {
        ...
        public:
            TriggerFactoryInternal()
            {
                ...
                creators["divine plea"] = [](PlayerbotAI* ai) { return new DivinePleaTrigger(ai); };
                creators["sacred shield"] = [](PlayerbotAI* ai) { return new SacredShieldTrigger(ai); };
                creators["aura mastery"] = [](PlayerbotAI* ai) { return new AuraMasteryTrigger(ai); };
                creators["divine storm"] = [](PlayerbotAI* ai) { return new DivineStormTrigger(ai); };
                creators["beacon of light"] = [](PlayerbotAI* ai) { return new BeaconOfLightTrigger(ai); };
                creators["divine illumination"] = [](PlayerbotAI* ai) { return new DivineIlluminationBoostTrigger(ai); };
                creators["hand of freedom on party"] = [](PlayerbotAI* ai) { return new HandOfFreedomTrigger(ai); };
            }
        };
        ...
        public:
            AiObjectContextInternal()
            {
                ...
                creators["divine sacrifice"] = [](PlayerbotAI* ai) { return new CastDivineSacrificeAction(ai); };
