    ...
    namespace druid
    {
        ...
        public:
            TriggerFactoryInternal()
            {
                ...
                creators["force of nature"] = [](PlayerbotAI* ai) { return new ForceOfNatureTrigger(ai); };
                creators["berserk"] = [](PlayerbotAI* ai) { return new BerserkTrigger(ai); };
                creators["active hot"] = [](PlayerbotAI* ai) { return new ActiveHotTrigger(ai); };
                creators["cyclone pvp"] = [](PlayerbotAI* ai) { return new CyclonePvpTrigger(ai); };
                creators["starfall"] = [](PlayerbotAI* ai) { return new StarfallTrigger(ai); };
                creators["predatory strikes"] = [](PlayerbotAI* ai) { return new PredatoryStrikesTrigger(ai); };
                creators["predatory strikes regrowth"] = [](PlayerbotAI* ai) { return new PredatoryStrikesRegrowthTrigger(ai); };
                creators["predatory strikes heal"] = [](PlayerbotAI* ai) { return new PredatoryStrikesHealTrigger(ai); };
                creators["typhoon"] = [](PlayerbotAI* ai) { return new TyphoonTrigger(ai); };
                creators["cyclone on target"] = [](PlayerbotAI* ai) { return new CycloneOnTargetTrigger(ai); };
            }
        };
        ...
        public:
            AiObjectContextInternal()
            {
                ...
                creators["force of nature"] = [](PlayerbotAI* ai) { return new CastForceOfNatureAction(ai); };
                creators["savage roar"] = [](PlayerbotAI* ai) { return new CastSavageRoarAction(ai); };
                creators["wild growth"] = [](PlayerbotAI* ai) { return new CastWildGrowthAction(ai); };
                ...
                creators["cyclone"] = [](PlayerbotAI* ai) { return new CastCycloneAction(ai); };
                creators["typhoon"] = [](PlayerbotAI* ai) { return new CastTyphoonAction(ai); };;
            }
        };
    };
};
