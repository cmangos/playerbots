    ...
    namespace warrior
    {
        ...
        public:
            TriggerFactoryInternal()
            {
                ...
                creators["mortal strike"] = [](PlayerbotAI* ai) { return new MortalStrikeCanCastTrigger(ai); };
                creators["mortal strike debuff"] = [](PlayerbotAI* ai) { return new MortalStrikeDebuffTrigger(ai); };
