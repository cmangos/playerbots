...
namespace ai
{
    ...
    public:
        TriggerContext()
        {
            ...
            creators["enemy player ten yards target bot"] = [](PlayerbotAI* ai) { return new EnemyInRangeTrigger(ai, "enemy player ten yards target bot", 10.0f, true, true); };
            ...
            creators["bg waiting"] = [](PlayerbotAI* ai) { return new BgWaitingTrigger(ai, 30); };
            creators["arena waiting"] = [](PlayerbotAI* ai) { return new BgWaitingTrigger(ai, 10); };
            creators["bg active"] = [](PlayerbotAI* ai) { return new BgActiveTrigger(ai, 1); };
            creators["arena active"] = [](PlayerbotAI* ai) { return new BgActiveTrigger(ai, 2); };
            ...
            creators["pvp trinket"] = [](PlayerbotAI* ai) { return new PvpTrinketTrigger(ai, false); };
            ...
            creators["every man for himself"] = [](PlayerbotAI* ai) { return new PvpTrinketTrigger(ai, true); };
