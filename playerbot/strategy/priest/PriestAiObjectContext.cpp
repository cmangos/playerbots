    ...
    namespace priest
    {
        ...
        public:
            TriggerFactoryInternal()
            {
                ...
                creators["shadow word: pain active"] = [](PlayerbotAI* ai) { return new ShadowWordPainActiveTrigger(ai); };
                ...
                creators["mana burn"] = [](PlayerbotAI* ai) { return new ManaBurnTrigger(ai); };
                creators["psychic horror"] = [](PlayerbotAI* ai) { return new PsychicHorrorTrigger(ai); };
            }
        };
        ...
        public:
            AiObjectContextInternal()
            {
                ...
                creators["penance"] = [](PlayerbotAI* ai) { return new CastPenanceAction(ai); };
                creators["penance on party"] = [](PlayerbotAI* ai) { return new CastPenanceOnPartyAction(ai); };
                creators["mind sear"] = [](PlayerbotAI* ai) { return new CastMindSearAction(ai); };
                creators["psychic horror"] = [](PlayerbotAI* ai) { return new CastPsychicHorrorAction(ai); };
