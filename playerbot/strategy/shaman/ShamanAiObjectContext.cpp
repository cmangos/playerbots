    ...
    namespace shaman
    {
        ...
        public:
            TriggerFactoryInternal()
            {
                ...
                creators["flame shock on target"] = [](PlayerbotAI* ai) { return new FlameShockOnTargetTrigger(ai); };
                ...
                creators["maelstrom weapon heal"] = [](PlayerbotAI* ai) { return new MaelstromWeaponHealTrigger(ai); };
        ...
        public:
            AiObjectContextInternal()
            {
                ...
                creators["thunderstorm self"] = [](PlayerbotAI* ai) { return new CastThunderstormSelfAction(ai); };
                ...
                creators["hex"] = [](PlayerbotAI* ai) { return new CastHexAction(ai); };
                creators["tidal force"] = [](PlayerbotAI* ai) { return new CastTidalForceAction(ai); };
            }
        };
    };
};
