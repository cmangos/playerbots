    ...
    namespace warlock
    {
        ...
        public:
            TriggerFactoryInternal()
            {
                ...
                creators["drain soul affli"] = [](PlayerbotAI* ai) { return new DrainSoulAffliTrigger(ai); };
                ...
                creators["molten core"] = [](PlayerbotAI* ai) { return new MoltenCoreTrigger(ai); };
                creators["decimation"] = [](PlayerbotAI* ai) { return new DecimationTrigger(ai); };
                creators["demonic empowerment"] = [](PlayerbotAI* ai) { return new DemonicEmpowermentTrigger(ai); };
