...
namespace ai
{
    ...
    public:
        ActionContext()
        {
            ...
            creators["use pvp trinket"] = [](PlayerbotAI* ai) { return new UseTrinketAction(ai, true); };
            ...
            creators["arena move to center"] = [](PlayerbotAI* ai) { return new ArenaTactics(ai, "move to center"); };
...
#endif
#ifdef MANGOSBOT_TWO
            creators["every man for himself"] = [](PlayerbotAI* ai) { return new CastEveryManforHimselfAction(ai); };
#endif
