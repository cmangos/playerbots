...
void EnhancementShamanStrategy::InitCombatTriggers(std::list<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        "stormstrike",
        NextAction::array(0, new NextAction("stormstrike", ACTION_HIGH + 1),
                             new NextAction("fire nova", ACTION_HIGH),
                             new NextAction("lava lash", ACTION_NORMAL + 9), NULL)));
}
...
void EnhancementShamanAoeStrategy::InitCombatTriggers(std::list<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        "melee medium aoe",
        NextAction::array(0, new NextAction("fire nova", ACTION_HIGH + 4), NULL)));
...
void EnhancementShamanTotemsStrategy::InitCombatTriggers(std::list<TriggerNode*>& triggers)
{
    ...
    triggers.push_back(new TriggerNode(
        "fire totem",
        NextAction::array(0, new NextAction("flametongue totem", ACTION_NORMAL + 9), NULL)));
}
